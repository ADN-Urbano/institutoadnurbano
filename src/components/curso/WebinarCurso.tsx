...
/**
 * Webinar gratuito de la landing del curso: tarjeta coral con detalles +
 * mock de reproductor. CTA presentacional (sin backend, se cablea en Fase 2).
 */
export default function WebinarCurso({ webinar }: { webinar: CourseDetail["webinar"] }) {
  const details: [string, string][] = [
    ["Próxima sesión", webinar.nextSessionLabel || "Fecha por confirmar"],
    ["Duración", webinar.durationLabel],
